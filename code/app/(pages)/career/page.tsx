...
function CareersPage() {
  const jobOpenings = [
    {
      title: "Scientist/Engineer - Mechanical",
  ...
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 flex flex-col items-center">
      ...
      <div className="w-full max-w-6xl p-8">
        <h2 className="text-4xl font-bold text-left">Current Job Openings</h2>
      ...
      <div className="w-full max-w-6xl bg-white p-8 rounded-xl mt-10 mb-10">
        ...
        <p className="text-lg text-left font-medium">Phone: +91-80-22172294</p>
      </div>
    </div>
  );
}
